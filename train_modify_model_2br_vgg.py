...
# import os# i try to remove the error builder
...
checkpoints_folder = './modify/tf_ckpts_2br_vgg_modify'
# output_weights = 'output_2br_vgg/openpose_2br_vgg'
output_weights = 'modify/output_modify_2br_vgg/openppose_2br_vgg'
batch_size = 10
lr = 5e-5
max_epochs = 300
